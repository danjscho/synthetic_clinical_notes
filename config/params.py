...
# This contains the basic params needed to run the pipeline. Please see config.py for more details of the pipeline.
...
PARAMS = {
    "pipeline_config": {
        ...
        "add_abbreviations_to_content": 1.0,  # The probability a member of staff adds abbreviations to the content of notes
        ...
        "complex_journey_rate": 0.5,  # The rate to include complex journeys - those containing medical contradictions and multiple possible diagnoses.
        "novel_disease_rate": 0.5,  # For the table this sets it as a novel disease rate.
        "elective_admission_rate": 0,  # The chance of a patient having an elective admission as opposed to emergency
        "use_rare_admissions": False,  # If true, includes rare reasons for admissions
